...
export const COPY: Record<Locale, InvestCopy> = {
  es: {
    ...
    aboutStats: [
      ...
      { value: 'Experiencia comprobada', label: 'especializados en desarrollo inmobiliario turístico de alta gama' },
    ],
  ...
  en: {
    ...
    aboutStats: [
      ...
      { value: 'Proven expertise', label: 'specialized in high-end tourism real estate development' },
    ],
  ...
  he: {
    ...
    aboutStats: [
      ...
      { value: 'מומחיות מוכחת', label: 'התמחות בפיתוח נדל"ן תיירותי יוקרתי' },
    ],
